...
execute if block ~ ~ ~ air run function bss_items:func/generator_func/cobblestone/des_func
execute if block ~ ~1 ~ air run function bss_items:func/generator_func/cobblestone/des_func
